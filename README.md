...
```shell
python train_spline.py -s <path to COLMAP or NeRF Synthetic dataset>
```
...
```shell
python train_spline.py -s <path to COLMAP or NeRF Synthetic dataset> --eval # Train with train/test split
