...
class GaussianModel:
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float):
        points = normalize_point_cloud(pcd.points)
    ...
    def spline_splitter(self, max_grad, min_opacity, extent, max_screen_size):
        # get gradient tensor for optimization parameters
        grads = self.xyz_gradient_accum / self.denom
        grads[grads.isnan()] = 0.0
...
def normalize_point_cloud(points):
    ...
    center = (min_coords + max_coords) / 2. # Calculate the center of the bounding box
